...
//updation
//psum=lsum+rsum
//psuff=max(rsuff,rsum+lsuff)
//ppref=max(lpref,lsum+rpref)
//pans=max(lans,rans,lsuff+rpref)

//Que:there are queries such that after each updation we have to print max sum of segment in the array
